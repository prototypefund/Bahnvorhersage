...
class Datasets:
    def __init__(self):
        ...
        self.rtd = dd.read_parquet(
            RTD_CACHE_PATH + '_hyper_dataset', engine='pyarrow'
        ).persist()
...
if __name__ == '__main__':
    ...
    for ar_or_dp in ['ar', 'dp']:
        for threshhold in CLASSES_TO_COMPUTE:
            ...
            def current_objective(trial):
                return objective(trial, threshhold, ar_or_dp)
            ...
            pd.DataFrame(
                ...
                'hyperparametertuning_2', con=DB_CONNECT_STRING, if_exists='append'
            )
